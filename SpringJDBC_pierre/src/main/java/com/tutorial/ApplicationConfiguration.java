...
public class ApplicationConfiguration extends WebMvcConfigurerAdapter {
	...
	// dataSource
	// .setUrl("jdbc:postgresql://localhost:5432/tutoSpringDB;DB_CLOSE_DELAY=-1;DB_CLOSE_ON_EXIT=FALSE");
	...
	// @Bean
	// public UserMapper userMapper(DataSource dataSource) throws Exception {
	// final SqlSessionTemplate sessionTemplate = new SqlSessionTemplate(
	// ((SqlSessionFactoryBean) sqlSessionFactory(dataSource))
	// .getObject());
